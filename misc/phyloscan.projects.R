...
{	
	...
	{
		require(big.phylo)
		cmd		<- cmd.hpcwrapper.cx1.ic.ac.uk(hpc.walltime=16, hpc.q="pqeelab", hpc.mem="36gb",  hpc.nproc=1, hpc.load="module load intel-suite/2015.1 mpi R/3.3.3 raxml/8.2.9 mafft/7 anaconda/2.3.0 samtools")
		#cmd		<- cmd.hpcwrapper.cx1.ic.ac.uk(hpc.walltime=18, hpc.q=NA, hpc.mem="96gb",  hpc.nproc=1, hpc.load="module load intel-suite/2015.1 mpi R/3.3.3 raxml/8.2.9 mafft/7 anaconda/2.3.0 samtools")
