...
### TSI estimates
```{r,eval=FALSE}
Rscript ~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/make_trees.R --out_dir_base "/rds/general/project/ratmann_deepseq_analyses/live/myfirstrun/" --pkg_dir "~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/" --iqtree_option "-m GTR+F+R6" --date "2022-02-22"
```
...
```{r,eval=FALSE}
Rscript ~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/make_trees.R --out_dir_base "/rds/general/project/ratmann_deepseq_analyses/live/mysecondrun/" --pkg_dir "~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/" --iqtree_option "-m GTR+F+R6 -o REF_CON_H" --date "2022-02-22"
```
...
### TSI estimates
```{r,eval=FALSE}
Rscript ~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/check_trees.R --out_dir_base "/rds/general/project/ratmann_deepseq_analyses/live/myfirstrun/" --pkg_dir "~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/" --iqtree_method "GTR+F+R6"
```

### Transmission pair analysis
```{r,eval=FALSE}
Rscript ~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/check_trees.R --out_dir_base "/rds/general/project/ratmann_deepseq_analyses/live/mysecondrun/" --pkg_dir "~/Phyloscanner.R.utilities/misc_data_analysis_RCCS1519/software/" --iqtree_method "GTR+F+R6" --iqtree_root "REF_CON_H"
```
