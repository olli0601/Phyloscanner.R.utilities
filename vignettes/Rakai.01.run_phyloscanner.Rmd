...
### Introduction: analysis of population-based sample
...
*phyloscanner* analyses on a population-based sample. Each analysis corresponds
to a batch of patients that are analysed jointly. 
